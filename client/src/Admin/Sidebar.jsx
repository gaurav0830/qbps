    ...
    return (
        <div className="fixed left-0 top-0 h-full w-64 m-3 rounded-lg bg-gray-200 p-6 shadow-lg flex flex-col border-2 border-gray-900">
            ...
            <nav className="flex flex-col space-y-4 mb-auto ">
                <Link to="/Admin/dashboard" className="flex items-center text-black hover:text-indigo-400 transition duration-200">
                    <FaTachometerAlt className="mr-3" />
                    Dashboard
                </Link>
                <Link to="/Admin/register" className="flex items-center text-black hover:text-indigo-400 transition duration-200">
                    <FaFileAlt className="mr-3"/>
                    Add Users
                </Link>
                
                <Link to="/questionpapers" className="flex items-center text-black hover:text-indigo-400 transition duration-200">
